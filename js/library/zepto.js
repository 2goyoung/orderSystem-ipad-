...
/*
增加'swipe', 'swipeLeft', 'swipeRight', 'swipeUp', 'swipeDown', 'doubleTap', 'tap', 'singleTap', 'longTap' 一系列手势事件
处理桌面平台与移动平台点击事件兼容 By zhangguoyong
*/
; (function ($) {
    ...
    $(document).ready(function () {
        ...
        if (hasTouch) {
            //$(document.body).bind('click', function (e) { e.preventDefault(); });
            $(document.body).bind('touchstart', function (e) {
                ...
                if (touch.isDoubleTap) {
                    ...
                    // swipe
                } else if ((touch.x2 && Math.abs(touch.x1 - touch.x2) > 100) ||
                           (touch.y2 && Math.abs(touch.y1 - touch.y2) > 100)) {
            ...
            //    //e.preventDefault();
                ...
                $(parentIfText(e.target)).one('click', function (event) {
                    $(this).trigger('tap');
                    e.preventDefault();
                    e.stopPropagation();
